      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-end justify-between mb-8">
          <div>
            ...
            <p className="text-slate-400 mt-1">Hand-picked singles, slabs &amp; sealed products</p>
          </div>
          <Link
            href="/shop"
        ...
        {/* Market price placeholder notice */}
        <div className="mb-6 p-3 bg-purple-900/20 border border-purple-700/30 rounded-lg text-sm text-purple-300">
          <span className="font-semibold">Coming Soon:</span> Real-time market pricing via Collectr integration.
          Prices shown reflect current store pricing.
        </div>
